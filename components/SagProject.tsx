...
import SagProjectScreen from "../imports/SagProjectScreen";
import ProjectNavigation from "./ProjectNavigation";

interface SagProjectProps {
  onBack: () => void;
}

export default function SagProject({ onBack }: SagProjectProps) {
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#111111] relative">
      <style>{`
        ...
        [data-name*="SAG"] .absolute[style*="bottom-[-"] {
          display: none !important;
        }
      `}</style>
      ...
      <ProjectNavigation 
        projectName="SAG" 
        projectCategory="INNOVATION & DIGITAL"
        onBack={onBack}
      />
